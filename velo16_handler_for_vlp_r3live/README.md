...
- And this is the modified version for R3LIVE
- For <param name="feature_extract_enable" type="bool" value="0"/> in https://github.com/hku-mars/FAST_LIO/blob/a56a0c544ae305e9b00ca4cd4e262d20703fdaa8/launch/mapping_velodyne.launch#L8, maybe the content in 'if(feature_enabled){...}' can be removed, then
